...
def main(sample_space_size):
    ...
    fileName = setUpSampleSpace(sample_space_size)
    ...
    train_x_full_kg_batch, train_obj_kg_batch, cumulative_cost_kg_batch, index_store_kg_batch = run_entire_cycle_batch(
        N_EXP_BATCH,
        fileName,
        INIT_SAMPLE_SIZE_BATCH, 
        runKG,
    ...
    searchDictBatch = {
        ...
        "MF-KG": (train_x_full_kg_batch, train_obj_kg_batch, cumulative_cost_kg_batch),
